    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (FileItem fi :fileItems) {
                fileName = Calendar.getInstance().getTimeInMillis()+fi.getName().substring(fi.getName().lastIndexOf("."),fi.getName().length());
