...
//	private ActivityService activityService;
	...
	public @ResponseBody Map<String,Object> selectActivityById(HttpServletRequest request, HttpServletResponse response)
	{
		Map<String,Object> map = new HashMap<String,Object>();
		try{
			int activityId = Integer.parseInt(request.getParameter("activityId"));
			map.put("list", mapper.selectActivityById(activityId));
			map.put("result", NameSpace.SUCCESS);
		}catch(Exception e){
			e.printStackTrace();
			map.put("result", NameSpace.FAIL);
